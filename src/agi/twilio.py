...
@tool
def send_message(*, session: Session, super_agent: SuperAgent, message: str, wait_for_response: bool) -> str:
    """
    ...
    ThreadItem.create(session=session, super_agent=super_agent, msg=AIMessage(content=message))
